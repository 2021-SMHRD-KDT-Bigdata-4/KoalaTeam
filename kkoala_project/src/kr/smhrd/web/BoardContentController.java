...
// POJO (Plain Old Java Object) : FrontController ---요청---> POJOS
...
//			out.println("<td><textarea rows='8' cols='50' name='contents'>"+vo.getContents()+"</textarea></td>");
//			out.println("</tr>");
//			out.println("<tr>");
...
//			
//		}
		return "boardContent"; //ViewName (논리적인 뷰의 이름) -> /WEB-INF/views/boardContent.jsp(물리적인 경로)
	}
