						...
						<form id="ufrm" class="checkout-form" method="post">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="row">
										<div class="col-lg-12">
											<label for="fir">ID<span>*</span></label> <input type="text"
												id="user_id" value="${sessionScope.userVO.user_id}"
												readonly="readonly" name="user_id">
										</div>
										<div class="col-lg-12">
											<label for="last">이름<span>*</span></label> <input type="text"
												id="user_name" value="${sessionScope.userVO.user_name}" name="user_name">
										</div>
										<div class="col-lg-12">
											<label for="cun-name">비밀번호</label> <input type="password"
												id="password" value="${sessionScope.userVO.password}" name="password">
										</div>
										<div class="col-lg-12">
											<label for="cun">생년월일<span>*</span></label> <input
												type="text" id="birth_date"
												value="${sessionScope.userVO.birth_date}" name="birth_date">
										</div>
										<div class="col-lg-12">
