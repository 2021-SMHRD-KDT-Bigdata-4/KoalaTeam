...
function callBack(data){
	...
	view+="<tr>";
	view+=" <th>게시글번호</th>";
	view+="<th class='p-name'>제목</th>";
	view+="<th>조회수</th>";
	view+="<th>작성자</th>";
	view+="<th>작성일</th>";
	view+="<th><i class='ti-close'></i></th>";	
	view+="</tr>";
	view+="</thead>";
	view+="<tbody>";
	view+="<h5>사랑합니다</h5>";
	...
	$.each(data,(index,obj)=>{ 
		view+="<tr>";
		view+="<td class='cart-pic first-row' id='user_id"+index+"'>"+obj.idx+"</td>";
		view+="<td class='cart-title first-row' ><a href='javascript:contentFn("+index+")'>"+obj.title+"</a></td>";
		
		view+="</td>";
		view+="<td  class='p-price first-row' >"+obj.count+"</td>";
		view+="<td  class='qua-col first-row'>"+obj.writer+"</td>";
		view+="<div class='quantity'>";
		view+="<div class='pro-qty'>";
		view+="</div>";
		view+="</div>";
		view+="</td>";
		view+="<td  class='total-price first-row'>"+obj.indate+"</td>";
		view+="<td class='close-td first-row'><i class='ti-close'></i></td>";
